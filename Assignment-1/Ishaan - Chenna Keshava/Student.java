...
// csvfile contains the absolute address of the input file
    ...
    //this functions finds all students belonging to a given class
	...
	try(BufferedReader br = new BufferedReader(new FileReader(csvfile))){
	    ...
	    {
		String[] comp = line.split(csvSplitBy);
// trim function is used to remove leading and trailing spaces from the records
	...
	//objects created for both the classes.
...
//searchString function is used for the first two purposes, by specifying the not required parameter as -1 or as a null string.
